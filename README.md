...
-------------------------------------------------------------------
**The "existing_Project folder" app works without ai api need ( was made because sending a csv file with 1000 rows may take time to reply by the ai it may also lag , so i used this rule - based prototype)**
